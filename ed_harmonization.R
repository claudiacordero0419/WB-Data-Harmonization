...
in_path <- "output/ed_panel_wide.csv"
out_dir <- "output"
...
#----Save outputs----
panel_csv <- file.path(out_dir, "ed_latam50_panel_25y.csv")
panel_xlsx <- file.path(out_dir, "ed_latam50_panel_25y.xlsx")

latest_csv <- file.path(out_dir, "ed_latam50_latest_country_wide.csv")
latest_xlsx <- file.path(out_dir, "ed_latam50_latest_country_wide.xlsx")
