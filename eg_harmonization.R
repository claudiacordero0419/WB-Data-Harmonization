...
in_path <- "output/eg_panel_wide.csv"
out_dir <- "output"
...
#Load Economy & Growth wide-format data
...
# -----------------------------
# Build LATAM + Caribbean country list using WB metadata (robust)
# -----------------------------
...
panel_csv <- file.path(out_dir, "eg_latam50_panel_25y.csv")
panel_xlsx <- file.path(out_dir, "eg_latam50_panel_25y.xlsx")

latest_csv <- file.path(out_dir, "eg_latam50_latest_country_wide.csv")
latest_xlsx <- file.path(out_dir, "eg_latam50_latest_country_wide.xlsx")
